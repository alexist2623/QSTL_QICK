...
proc create_hier_cell_ddr4 { parentCell nameHier } {
  ...
  set_property -dict [list \
      CONFIG.DEFAULT_TRIGGER_DELAY_CYCLES {8677} \
  ...
  connect_bd_intf_net -intf_net axis_fir_decim_300to1_v1_0_m_axis [get_bd_intf_pins axis_fir_decim_300to1_v1_0/m_axis] [get_bd_intf_pins axis_buffer_ddr_sample_v2_0/s_axis]
  ...
  connect_bd_net -net rst_adc_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins axis_buffer_ddr_sample_v2_0/s_axis_aresetn] [get_bd_pins axis_fir_decim_300to1_v1_0/aresetn] [get_bd_pins axis_trigger_sync_v1_0/aresetn]
  ...
  connect_bd_net -net usp_rf_data_converter_0_clk_adc2 [get_bd_pins aclk] [get_bd_pins axis_buffer_ddr_sample_v2_0/s_axis_aclk] [get_bd_pins axis_fir_decim_300to1_v1_0/aclk] [get_bd_pins axis_trigger_sync_v1_0/aclk]
