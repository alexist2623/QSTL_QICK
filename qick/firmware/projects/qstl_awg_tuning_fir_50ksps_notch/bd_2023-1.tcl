...
QICK:QICK:axis_notch_decim_1m_to50k_v1:1.0\
...
proc create_hier_cell_ddr4 { parentCell nameHier } {
  ...
  # Continuous 1 MSPS to 50 kSPS anti-alias and double-notch cascade.
  set axis_notch_decim_1m_to50k_v1_0 [ create_bd_cell -type ip -vlnv QICK:QICK:axis_notch_decim_1m_to50k_v1:1.0 axis_notch_decim_1m_to50k_v1_0 ]
  set_property -dict [list \
    CONFIG.DECIMATION_PARAM {20} \
    CONFIG.M_AXIS_DATA_WIDTH {32} \
    CONFIG.S_AXIS_DATA_WIDTH {32} \
  ] $axis_notch_decim_1m_to50k_v1_0
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axis_buffer_ddr_sample_v2_0_m_axi [get_bd_intf_pins axi_smc_1/S01_AXI] [get_bd_intf_pins axis_buffer_ddr_sample_v2_0/m_axi]
  connect_bd_intf_net -intf_net axis_fir_decim_300to1_v1_0_m_axis [get_bd_intf_pins axis_fir_decim_300to1_v1_0/m_axis] [get_bd_intf_pins axis_notch_decim_1m_to50k_v1_0/s_axis]
  connect_bd_intf_net -intf_net axis_notch_decim_1m_to50k_v1_0_m_axis [get_bd_intf_pins axis_notch_decim_1m_to50k_v1_0/m_axis] [get_bd_intf_pins axis_buffer_ddr_sample_v2_0/s_axis]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M22_AXI [get_bd_intf_pins s_axi] [get_bd_intf_pins axis_buffer_ddr_sample_v2_0/s_axi]
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins rst_ddr4/peripheral_aresetn] [get_bd_pins axis_buffer_ddr_sample_v2_0/m_axi_aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins ddr4_0/c0_ddr4_aresetn]
  connect_bd_net -net ddr4_0_c0_ddr4_ui_clk [get_bd_pins ddr4_0/c0_ddr4_ui_clk] [get_bd_pins c0_ddr4_ui_clk] [get_bd_pins axis_buffer_ddr_sample_v2_0/m_axi_aclk] [get_bd_pins rst_ddr4/slowest_sync_clk] [get_bd_pins axi_smc_1/aclk]
  ...
  connect_bd_net -net fir_trigger_disabled [get_bd_pins fir_trigger_disable/dout] [get_bd_pins axis_fir_decim_300to1_v1_0/trigger]
  connect_bd_net -net ddr4_capture_trigger [get_bd_pins axis_trigger_sync_v1_0/trigger_pulse] [get_bd_pins axis_buffer_ddr_sample_v2_0/trigger]
  connect_bd_net -net rst_100_bus_struct_reset [get_bd_pins sys_rst] [get_bd_pins ddr4_0/sys_rst]
  connect_bd_net -net rst_adc_peripheral_aresetn [get_bd_pins aresetn] [get_bd_pins axis_buffer_ddr_sample_v2_0/s_axis_aresetn] [get_bd_pins axis_fir_decim_300to1_v1_0/aresetn] [get_bd_pins axis_notch_decim_1m_to50k_v1_0/aresetn] [get_bd_pins axis_trigger_sync_v1_0/aresetn]
  connect_bd_net -net rst_ps8_0_99M_peripheral_aresetn [get_bd_pins s_axi_aresetn] [get_bd_pins axis_buffer_ddr_sample_v2_0/s_axi_aresetn]
  connect_bd_net -net usp_rf_data_converter_0_clk_adc2 [get_bd_pins aclk] [get_bd_pins axis_buffer_ddr_sample_v2_0/s_axis_aclk] [get_bd_pins axis_fir_decim_300to1_v1_0/aclk] [get_bd_pins axis_notch_decim_1m_to50k_v1_0/aclk] [get_bd_pins axis_trigger_sync_v1_0/aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_aclk] [get_bd_pins axis_buffer_ddr_sample_v2_0/s_axi_aclk]
...
proc create_root_design { parentCell } {
  ...
  set CLK104_PL_CLK_P [ create_bd_port -dir I -type clk -freq_hz 400000000 CLK104_PL_CLK_P ]
  set CLK104_PL_CLK_N [ create_bd_port -dir I -type clk -freq_hz 400000000 CLK104_PL_CLK_N ]
...
\
  ...
  assign_bd_address -offset 0xA00A0000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ddr4/axis_buffer_ddr_sample_v2_0/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces ddr4/axis_buffer_ddr_sample_v2_0/m_axi] [get_bd_addr_segs ddr4/ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
