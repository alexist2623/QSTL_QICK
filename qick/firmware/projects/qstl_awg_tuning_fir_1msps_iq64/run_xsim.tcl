...
set fir_dir [file join $ip_dir axis_fir_decim_300to1_v2]
set ddr_dir [file join $ip_dir axis_buffer_ddr_sample_v3 src]
run_checked [list xvlog -sv \
    [file join $fir_dir src fir_decim_300to1_v2_coeffs_pkg.sv] \
    [file join $fir_dir src axis_fir_decim_full_precision_stage.sv] \
    [file join $fir_dir src axis_fir_decim_300to1_v2.sv] \
    [file join $fir_dir src tb_axis_fir_decim_300to1_v2.sv] \
    [file join $ip_dir axis_trigger_sync_v1 src axis_trigger_sync_v1.sv] \
    [file join $ddr_dir axis_buffer_ddr_sample_v3.sv] \
    [file join $ddr_dir tb_axis_buffer_ddr_sample_v3.sv] \
    [file join $project_dir tb_fir_ddr_1msps_iq64.sv]]
foreach top {tb_axis_buffer_ddr_sample_v3 tb_axis_fir_decim_300to1_v2 tb_fir_ddr_1msps_iq64} {
...
puts "PASS: all 1 MSPS IQ64 RTL regressions"
exit 0
