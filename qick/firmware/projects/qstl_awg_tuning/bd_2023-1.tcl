...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_awg_tuning_v1_0.
  # This qstl_awg_tuning variant reuses tProcessor m8_axis as the AWG tuning
  # command source and routes the generated vector stream into one DAC path.
