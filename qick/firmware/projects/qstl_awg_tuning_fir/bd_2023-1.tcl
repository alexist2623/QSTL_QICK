...
proc create_hier_cell_ddr4 { parentCell nameHier } {
  ...
  # Create instance: axis_buffer_ddr_sample_v1_0, and set properties
  set axis_buffer_ddr_sample_v1_0 [ create_bd_cell -type ip -vlnv QICK:QICK:axis_buffer_ddr_sample_v1:1.0 axis_buffer_ddr_sample_v1_0 ]
  set_property -dict [list \
  ...
  connect_bd_net -net ddr4_trigger_align [get_bd_pins axis_trigger_sync_v1_0/trigger_pulse] [get_bd_pins axis_fir_decim_300to1_v1_0/trigger]
  connect_bd_net -net ddr4_capture_trigger_compensated [get_bd_pins axis_fir_decim_300to1_v1_0/capture_trigger] [get_bd_pins axis_buffer_ddr_sample_v1_0/trigger]
...
\
  ...
  assign_bd_address -offset 0xA00A0000 -range 0x00001000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs ddr4/axis_buffer_ddr_sample_v1_0/s_axi/reg0] -force
  ...
  assign_bd_address -offset 0x00000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces ddr4/axis_buffer_ddr_sample_v1_0/m_axi] [get_bd_addr_segs ddr4/ddr4_0/C0_DDR4_MEMORY_MAP/C0_DDR4_ADDRESS_BLOCK] -force
